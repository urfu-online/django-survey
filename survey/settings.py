...
# MESSAGES_PER_PAGE = getattr(environ, "ROSETTA_MESSAGES_PER_PAGE", 10)
#
# ROOT = os.path.dirname(os.path.abspath(__file__))
# USER_DID_NOT_ANSWER = getattr(env, "USER_DID_NOT_ANSWER", "Left blank")
# TEX_CONFIGURATION_FILE = getattr(env, "TEX_CONFIGURATION_FILE", os.path.join(ROOT, "doc", "example_conf.yaml"))
# SURVEY_DEFAULT_PIE_COLOR = getattr(env, "SURVEY_DEFAULT_PIE_COLOR", "red!50")
# CHOICES_SEPARATOR = getattr(env, "CHOICES_SEPARATOR", ",")
